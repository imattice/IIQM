...
//3) Both the Array<Int> extension and the TextReader class can be easily tested.  We can develop these using TDD.
//4) Deprecate the old IIQM class so that future developers do not use it. This also sets it up to be permanently removed in the future
